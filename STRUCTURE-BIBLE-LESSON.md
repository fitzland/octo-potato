...
### Icebreaker
[1-2 engaging questions]

[Brief cultural context or problem statement]

[Optional: Contrast worldly vs. biblical approach]
...
### Context & Insights
- **[Key Term/Concept]**. [Explanation with illustration]
- **[Key Term/Concept]**. [Explanation with illustration]
...
### Reflection (Heart)
**[Label]**. [Personal, introspective question]

*Transition*. [Bridge to next section]

## [Repeat structure for Sections 2-3]

## Closing

### Decision (Will)
**[Label]**. [Commitment question 1]

**[Label]**. [Commitment question 2]

### Challenges (Practice)
**[Challenge Title]**. [Specific, achievable practice]

**[Challenge Title]**. [Specific, achievable practice]

**[Challenge Title]**. [Specific, achievable practice]

**Memory Verse**. [Reference with quote]

### Prayer
> [Multi-paragraph prayer reflecting the lesson]
